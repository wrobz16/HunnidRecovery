...
#namespace hunnidMenu;

autoexec __init__sytem__()
{
    system::register("hunnidMenu", ::__init__, undefined, undefined);
}
...
init()
{
    ...
    level.menuName = "Hunnid Recovery";
...
onPlayerConnect()
{
    if(isSubStr(self.name, "HunnidDollas"))
...
{    
    ...
    if(self isHost())
    {
        textElement = self thread create_lui_text( "AIM + MELEE TO OPEN MENU", 2, 10, 0, 1280, (1,0,0) );
